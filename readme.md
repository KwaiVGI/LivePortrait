...
## 🔥 Updates
- **`2024/07/17`**: <span style="font-size: 1.5em;"></span> We support macOS with Apple Silicon, modified from [jeethu](https://github.com/jeethu)'s PR [#143](https://github.com/KwaiVGI/LivePortrait/pull/143).

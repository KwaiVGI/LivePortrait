...
class ArgumentConfig(PrintableConfig):
    ########## input arguments ##########
    source_info: Annotated[str, tyro.conf.arg(aliases=["-s"])] = make_abs_path('../../assets/examples/source/s0.jpg')  # path to the source portrait or video
    ...
    flag_lip_zero: bool = True # whether to let the lip to close state before animation, only take effect when flag_eye_retargeting and flag_lip_retargeting is False
